...
import { PortalPropuestaList } from '@/components/tickets/portal-propuesta-list'

export default async function PortalPropuestasPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const docs = await prisma.clientDocument.findMany({
    where: { clientId: client.id, type: 'propuesta' },
  ...
  return (
    <PortalShell
      ...
      activeHref={`/portal/${slug}/propuestas`}
